 ...
 *  Dependencies: ArraySearcher.java Term.java
 *
 ...
 *  @author Kevin Lin
 *
 *  Interactive GUI used to demonstrate the ArraySearcher data type.
 *
...
/**
 * A demo GUI that uses Autocomplete to offer autocomplete suggestions to a user.
 *
 * We don't expect you to understand the things that go on in this file, and UI code tends to be
 * particularly complex (especially this class, which exemplifies the "God object" anti-pattern),
 * so we recommend that you stop reading here.
 */
public class AutocompleteGUI extends JFrame {
    ...
    private static final String FILENAME = "autocomplete/data/cities.txt";

    // Indicates whether to display weights next to query matches
    private boolean displayWeights = true;

    /** Initializes the GUI, and the associated ArraySearcher object */
    ...
    /**
     * The panel that interfaces with the ArraySearcher object.  It consists
    ...
    private class AutocompletePanel extends JPanel {
        ...
        private Autocomplete auto;                  // the ArraySearcher object
        ...
        /**
         * Creates the ArraySearcher object and the search bar and suggestion
         * drop-down portions of the GUI
         * @param filename the file the ArraySearcher object is constructed from
         */
        public AutocompletePanel(String filename) {
            super();

            // Create the autocomplete object
            auto = Autocomplete.loadFromFile(filename);
        ...
        /**
         * Makes a call to the implementation of ArraySearcher to get
        ...
        public void getSuggestions(String text) {
            ...
            if (text.equals("")) {
                ...
                Term[] allResults = auto.findMatchesForPrefix(text);
                if (allResults == null) {
